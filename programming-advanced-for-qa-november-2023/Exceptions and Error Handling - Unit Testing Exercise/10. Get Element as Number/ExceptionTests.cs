...
public class ExceptionTests
{
    ...
    public void Test_GetElementAsNumber_KeyNotFound_ThrowsKeyNotFoundException()
    {
        ...
        Assert.That(()=> _exceptions.GetElementAsNumber(dictionary,key), Throws.InstanceOf<KeyNotFoundException>());
    }
    ...
    public void Test_GetElementAsNumber_InvalidFormat_ThrowsFormatException()
    {
        ...
        Assert.That(() => _exceptions.GetElementAsNumber(dictionary,key),Throws.InstanceOf<FormatException>());
    }
}
